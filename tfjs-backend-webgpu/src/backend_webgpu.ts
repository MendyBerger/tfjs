...
export class WebGPUBackend extends KernelBackend {
  ...
  runFromPixelsProgram(
      program: FromPixelsProgram, output: TensorInfo,
    ...
    const key =
        webgpu_program.makeShaderKey(program, outputShapes, outputTypes);
    ...
    if (useImport) {
      ...
      externalResource = texture.createView();
    }
